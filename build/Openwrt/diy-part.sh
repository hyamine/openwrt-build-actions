...
uci set network.lan.ipaddr='192.168.8.3'                        # IPv4 地址(openwrt后台地址)
uci set network.lan.netmask='255.255.255.0'                     # IPv4 子网掩码
uci set network.lan.gateway='192.168.8.1'                       # IPv4 网关
uci set network.lan.broadcast='192.168.8.255'                   # IPv4 广播
uci add_list network.lan.dns='202.96.128.166'                        # OpenWrt官方源码，dns设置
uci add_list network.lan.dns='114.114.114.114'                  # OpenWrt官方源码，dns设置
#uci set network.lan.dns='202.96.128.166 114.114.114.114'            # DNS(多个DNS要用空格分开)
